...
import { IoIosArrowDown } from "react-icons/io"; // old ios icons
  ...
  return (
    <header className="sticky top-0 z-[10000]">
      ...
      <div className="bg-white shadow dark:bg-gray-900">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-4 lg:py-6">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2">
            <img
              src="https://i.ibb.co/kgBg7BN2/Untitled-4.jpg"
              alt="Logo"
          ...
          <nav className="hidden lg:flex gap-6 text-gray-700 dark:text-white text-md font-medium">
            ...
            <Link to="/health-tips">স্বাস্থ্য পরামর্শ</Link>
            ...
            {userInfo ? (
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                  <FaRegUser />
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 shadow rounded z-[10000] animate-slide-down">
                    <Link
              ...
              <Link
                to="/login"
                className="text-md px-3 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition"
              >
                সাইন ইন
              </Link>
            )}
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white dark:bg-gray-900 px-4 pb-4 animate-fade-in">
